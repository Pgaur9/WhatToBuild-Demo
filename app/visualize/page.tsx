...
function VisualizePageContent() {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-2">Architecture Diagram: <span className="text-purple-400">{repoFullName}</span></h1>
      <p className="text-lg text-gray-400 mb-8">
        This diagram was automatically generated by analyzing the repository's README file.
      </p>

      <div className="w-full">
        {isLoading && (
          <div className="border-2 border-dashed border-gray-700 bg-gray-900/20 rounded-lg min-h-[500px] flex items-center justify-center p-8">
            <p className="text-gray-400 text-xl animate-pulse">AI is analyzing the README and generating a diagram...</p>
          </div>
        )}
