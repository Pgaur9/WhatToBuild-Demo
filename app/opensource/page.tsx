      ...
      <main>
        ...
        {sortedRepositories.length > 0 && (
          <div className="flex justify-end mb-4">
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500/0 via-indigo-500/10 to-purple-500/0 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 rounded-xl"></div>
        ...
        {!isLoading && !isLoadingMore && sortedRepositories.length === 0 && (
          <div className="bg-black/30 backdrop-blur-xl border border-white/20 rounded-xl p-8 text-center shadow-lg my-8 relative group overflow-hidden">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500/0 via-indigo-500/10 to-purple-500/0 blur-xl opacity-30 -z-10"></div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <h3 className="text-lg sm:text-xl font-medium text-white/90 flex items-center gap-2">
                          <Tag className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-400" />
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <Button
                                      ...
                                      className="bg-indigo-500/20 border-indigo-400/30 text-indigo-300 hover:bg-indigo-500/30 hover:border-indigo-400/50 hover:text-indigo-200 text-xs px-2 py-1 h-auto"
                                    >
                                      Explain
                                    </Button>
                                  </div>
        ...
        >
          ...
          <SheetHeader className="border-b border-white/10 pb-4 mb-4 sm:mb-6 flex-shrink-0 pt-12 sm:pt-8 lg:pt-12">
            <SheetTitle className="text-lg sm:text-xl font-bold text-white flex items-center gap-2 pr-8 sm:pr-0">
              <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-400 flex-shrink-0" />
                  ...
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ 
                      __html: explanation.replace(/\*\*(.*?)\*\*/g, '<strong class="text-white font-semibold break-words">$1</strong>')
                        ...
                        .replace(/`(.*?)`/g, '<code class="bg-white/10 px-1 py-0.5 rounded text-indigo-300 font-mono text-xs break-all">$1</code>')
                        ...
                        .replace(/^\d+\.\s/gm, '<span class="text-indigo-400 font-medium">•</span> ')
