    ...
    <tr className="hover:bg-black/40 transition-all duration-300 group border-b border-white/10 backdrop-blur-sm relative overflow-hidden animate-in fade-in slide-in-from-left-2 duration-500">
      ...
      <td className="py-4 px-4 hidden sm:table-cell">
        <div className="flex items-center">
          <span className="w-3 h-3 rounded-full bg-indigo-500 mr-2 shadow-sm shadow-indigo-500/30"></span>
        ...
        {repo.relevance_score ? (
          <div className="flex items-center">
            <div className="w-16 bg-black/30 rounded-full h-2 mr-2 backdrop-blur-sm border border-white/10">
              <div 
                className="bg-gradient-to-r from-indigo-500 to-purple-500 h-2 rounded-full transition-all duration-300 shadow-sm"
